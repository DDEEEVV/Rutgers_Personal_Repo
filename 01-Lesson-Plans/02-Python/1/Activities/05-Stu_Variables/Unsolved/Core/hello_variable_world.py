...
the_increase_in_price = current_price - original_price

# Calculate percent_increase
the_percentage_of_increase = (current_price - original_price) / original_price * 100
...
print(f"Thepercentage increase is: % {round(the_percentage_of_increase, 2)}")