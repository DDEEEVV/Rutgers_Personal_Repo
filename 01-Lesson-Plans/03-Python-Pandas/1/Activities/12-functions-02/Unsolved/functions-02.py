# Define a function "warble" that takes in a string as an argument, adds " argebargle" to the end of it, and returns the result.
from re import S


def warble(string_param):
    return(f"{string_param} agrebargle")
