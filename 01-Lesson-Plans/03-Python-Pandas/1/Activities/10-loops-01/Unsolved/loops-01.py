...
print("the index of the first occurrence of the number 11:")
index = 0
for number in num_list:
    if number == 11:
        print(index)
...
print("the number of times Apples appears in the list")
count = 0
for fruit in fruits:
  if fruit == "Apple":
    count +=1
...
print("number of fruits that start with P in the list")
count = 0
for fruit in fruits:
  if fruit[0] == "P":
    count +=1
...
print("All numbers that are multiple of 3")
sum = 0
for one_dim_list in two_dim_list:
  for number in one_dim_list:
    if number % 3 == 0:
